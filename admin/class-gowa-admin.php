                ...
                <form method="post" action="">
                    ...
                    <table class="form-table" role="presentation">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="gowa_settings[admin_phone]" type="text" id="admin_phone" value="<?php echo esc_attr( $config['admin_phone'] ); ?>" class="regular-text" placeholder="e.g. 8801840538790 or 14155552671">
                    ...
                    <div id="gowa_direct_send_box">
                        <table class="form-table" role="presentation">
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="gowa_direct_phone" value="<?php echo esc_attr( $config['admin_phone'] ); ?>" class="regular-text" placeholder="e.g. 01840538790 or +8801840538790">
