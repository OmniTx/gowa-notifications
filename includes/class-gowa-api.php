...
class GOWA_API {
     ...
     * 
     * Handles:
     * 1. JID strings (e.g. 8801840538790@s.whatsapp.net) -> returns trimmed
     * 2. Leading '+' (e.g. +8801840538790, +14155552671) -> strips '+'
     * 3. Leading '00' (e.g. 008801840538790) -> strips '00'
     * 4. Leading '0' with Configured Country Code:
     *    - BD (880): 01840538790 -> 8801840538790
     *    - ID (62): 08123456789 -> 628123456789
     *    - UK (44): 07123456789 -> 447123456789
     *    - IN (91): 09876543210 -> 919876543210
     * 5. Plain International numbers (e.g. 8801840538790, 14155552671) -> untouched
     *
     * @param string $phone
     * @return string
     */
