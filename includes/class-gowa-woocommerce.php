...
class GOWA_WooCommerce {
    ...
    public function ajax_send_order_custom_msg() {
        ...
        $phone    = isset( $_POST['phone'] ) ? sanitize_text_field( wp_unslash( <?php
/**
 * GOWA WooCommerce Integration, Order Actions & Dropdown
 */
...
class GOWA_WooCommerce {
    ...
    public function ajax_send_order_custom_msg() {
        ...
        $message  = isset( $_POST['message'] ) ? sanitize_textarea_field( wp_unslash( <?php
/**
 * GOWA WooCommerce Integration, Order Actions & Dropdown
 */
...
new GOWA_WooCommerce();POST['phone'] ) ) : '';
        $message  = isset( $_POST['message'] ) ? sanitize_textarea_field( $_POST['message'] ) : '';
...
new GOWA_WooCommerce();POST['message'] ) ) : '';
